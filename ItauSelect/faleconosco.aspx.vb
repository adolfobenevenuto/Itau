Public Partial Class faleconosco
  ...
  Protected Sub BtnEnviar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnEnviar.Click
    ...
    objEmail.To.Add("eventos04@crpsp.org.br")
    ...
    'título do e-mail 
    objEmail.Subject = "PSI Site do CRP SP - Eventos CRP SP - Livro "

    'corpo do e-mail 
    objEmail.Body = "Nome: " + TxtNome.Text + "<br><br> E-mail: " + TxtEmail.Text + "<br><br> Mensagem: " + TxtMsg.Text
