...
'Delegate to transaction dependent operations
Public Delegate Sub TransactionProcessor(ByVal context As SqlTransaction)

' The SqlHelper class is intended to encapsulate high performance, scalable best practices for 
' common uses of SqlClient.
Public NotInheritable Class SqlHelper

#Region "private utility methods , constructors & variables"

  'member variables
  Private Shared _connectionString As String = Configuration.ConfigurationSettings.AppSettings.Get("CONNECTION_STRING")
...
#Region "Connection"
  ...
  'Abre uma conexao com o banco de dados utilizando a 
  'string de conexao padrao
  Public Shared Function Connect() As SqlConnection

    'cria conexao
    Dim ret As New SqlConnection(_connectionString)
  ...
  'String de conexao padrao. Este valor corresponde ao valor configurado 
  'para a chave 'CONNECTION_STRING' do arquivo de configuracao da aplicacao.
...
#Region "Transaction processing"
  ...
  'Opens a transaction and calls a function passing the
  'open transaction as the parameter
  Public Shared Sub ProcessTransactionOperation(ByVal tranProcessor As TransactionProcessor)

    'Open connection
    Dim con As SqlConnection = Connect()
...
#Region "ExecuteNonQuery"
  ...
  ' -commandParameters - an array of SqlParamters used to execute the command
  ' Returns: an int representing the number of rows affected by the command
  Public Overloads Shared Function ExecuteNonQuery(ByVal commandText As String, _
                                                   ByVal ParamArray commandParameters() As SqlParameter) As Integer
    ' call overload
...
#Region "ExecuteDataset"
  ...
  ' -commandParameters - an array of SqlParamters used to execute the command
  ' Returns: a dataset containing the resultset generated by the command
  Public Overloads Shared Function ExecuteDataset(ByVal commandText As String, _
  ...
  ' -commandText - the stored procedure name or T-SQL command
  ' Returns: a dataset containing the resultset generated by the command
  Public Overloads Shared Function ExecuteDataset(ByVal commandText As String) As DataSet

    'call overload
    Return ExecuteDataset(ConnectionString, CommandType.Text, commandText, CType(Nothing, SqlParameter))
...
#Region "ExecuteReader"
  ...
  ' Returns: a SqlDataReader containing the resultset generated by the command 
  Public Overloads Shared Function ExecuteReader(ByVal commandText As String, _
                                                 ByVal ParamArray commandParameters() As SqlParameter) As SqlDataReader
    'call overload
  ...
  ' -commandParameters - array of SqlParameters for the command
  ' Returns: a SqlDataReader containing the resultset generated by the command 
  Public Overloads Shared Function ExecuteReader(ByVal commandText As String) As SqlDataReader

    'call overload
    Return ExecuteReader(commandText, CType(Nothing, SqlParameter()))
